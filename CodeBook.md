...
### Data
The data set includes the average of the mean and standard deviation of 33 signals from an  UCI HAR experiment carried out with 30 volunteers within an age bracket of 19-48 years which performed six activities. The data is sorted for each volunteer (subject) and each activity.
